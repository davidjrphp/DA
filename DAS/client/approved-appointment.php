...
?>
	...
	<head>
		...
		<title>DAS || Approved Appointment Detail</title>
										...
										foreach ($results as $row) {               ?>
											<tr>
												...
												<?php if ($row->Status == "") { ?>
													...
													<td><span class="badge badge-primary"><?php echo "Pednding"; ?></span></td>
												<?php } else { ?> <td><span class="badge badge-success"><?php echo htmlentities($row->Status); ?></span>
													</td>
												<?php } ?>

												<td><a href="view-appointment-detail.php?aptid=<?php echo htmlentities($row->AppointmentNumber); ?>" class="btn btn-primary">View</a></td>
