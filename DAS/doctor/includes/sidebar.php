    ...
    <div class="media">
      ...
      <div class="media-body">
        <div class="foldable">
          ...
          $sql = "SELECT FullName,Email from  clients where ID=:cid";
    ...
    <div class="menubar-scroll-inner">
      <ul class="app-menu">
        ...
        <li class="has-submenu">
          ...
          <ul class="submenu">
            <li><a href="new_staff.php"><span class="menu-text">New Staff</span></a></li>
            <li><a href="staff_list.php"><span class="menu-text">All Staff</span></a></li>
          </ul>
        </li>
        <li>
          <a href="search.php">
